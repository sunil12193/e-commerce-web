...
function Header() {
    ...
    return (
        <header >
            ...
            <div className=" ml-8 mr-8 flex justify-between items-center py-2">
                ...
                <div className="flex font-bold">
                    {menu.map((item) => (
                        <Link
                            ...
                            className={`cursor-pointer text-[16px] px-3 py-2 rounded ${active === item.key
                                    ? "bg-color text-[var(--color-text)]"
